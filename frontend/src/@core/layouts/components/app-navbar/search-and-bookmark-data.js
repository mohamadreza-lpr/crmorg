...
export default {
  pages: {
    key: 'title',
    data: [
      { title: 'صفحه اصلی', route: { name: 'dashboard-ecommerce' }, icon: 'HomeIcon', isBookmarked: true },
      { title: 'پیشخوان مشتری', route: { name: 'dashboard-customer' }, icon: 'UsersIcon', isBookmarked: false },
      { title: 'پیشخوان فروش', route: { name: 'dashboard-sale' }, icon: 'ShoppingCartIcon', isBookmarked: false },
      { title: 'پیشخوان تحلیل', route: { name: 'dashboard-analysis' }, icon: 'ActivityIcon', isBookmarked: false },
      { title: 'مشاهده کاربران', route: { name: 'apps-users-list' }, icon: 'UsersIcon', isBookmarked: false },
      { title: 'مجوزهای مدیران', route: { name: 'admin-permissons' }, icon: 'AlertOctagonIcon', isBookmarked: false },
      { title: 'برندینگ', route: { name: 'settings-branding' }, icon: 'BookmarkIcon', isBookmarked: false },
      { title: 'مشاهده شعب', route: { name: 'merchants' }, icon: 'CpuIcon', isBookmarked: false },
      { title: 'گام های وفاداری', route: { name: 'loyalty-plans' }, icon: 'StarIcon', isBookmarked: false },
      { title: 'مشاهده مشتریان', route: { name: 'customers-list' }, icon: 'UsersIcon', isBookmarked: false },
      // { title: 'مشتری جدید', route: { name: 'customers-createPerson' }, icon: 'UserPlusIcon', isBookmarked: true },
      { title: 'ایجاد فاکتور', route: { name: 'sales-createInvoice' }, icon: 'FilePlusIcon', isBookmarked: true },
      { title: 'مشاهده محصولات', route: { name: 'products-list' }, icon: 'ShoppingBagIcon', isBookmarked: false },
      { title: 'ایجاد محصول', route: { name: 'products-create' }, icon: 'ShoppingCartIcon', isBookmarked: false },
      { title: 'کوپن های تخفیف', route: { name: 'gift-coupones-list' }, icon: 'GiftIcon', isBookmarked: false },
    ...
    //   { title: 'Dashboard Analytics', route: { name: 'dashboard-customer' }, icon: 'ActivityIcon', isBookmarked: false },
