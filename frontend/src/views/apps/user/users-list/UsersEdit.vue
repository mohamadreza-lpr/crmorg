        ...
        userUpdateHandler() {
            ...
            const params = {
                ...
                gender: this.userForm.gender
                    ...
                    : undefined,
                groups_id: this.group ? this.group.id : undefined,
            ...
            axios
                ...
                .then((res) => {
                    ...
                    this.$router.replace("/users/list").then(() => {
                        this.$toast({
    ...
    created() {
        ...
        axios
            ...
            .then(({ data }) => {
                ...
                this.userForm.gender = _.find(this.gender_options, {
                ...
                this.userForm.introduction = _.find(
                    ...
                    (item) => {
                        return item.value == data.data.profile.acquaintance_type;
                    }
                );
                ...
                this.isSingle = this.userForm.marital_status ? !this.userForm.marital_status.value : false;
