            ...
            <b-col md="12" lg="12" sm="12">
                ...
                <BCard>
                    ...
                    <div class="text-right">
                        <b-button @click="userCreate" variant="success">
...
export default {
    ...
    methods: {
        singleStatusHanler(s) {
            this.isSingel = !s.value;
        ...
        userCreate() {
            const params = {
                ...
                tags: _.map(this.selected_tags, "tag_id"),
        ...
        provinceChanges() {
            axios
                .get(`${process.env.VUE_APP_URL}/roll`)
                .then(response => {})
                .catch(error => {});
        }
    },
