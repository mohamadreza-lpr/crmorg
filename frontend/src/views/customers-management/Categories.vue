...
export default {
    ...
    data() {
        return {
            ...
            addGroup: { name: undefined, type: undefined },

            editGroupFormSubmitted: false,
            editGroupModalFlag: false,
            editGroup: { name: undefined, type: undefined },
    ...
    created() {
        axios
            .get(`${process.env.VUE_APP_URL}/groups/all`, {
                headers: {
    ...
    methods: {
        ...
        editGroupHandler(bvModalEvt) {
            ...
            axios
                .patch(
                    `${process.env.VUE_APP_URL}/groups/${this.currentNode.id}/update`,
                    {
                        ...
                        type: this.editGroup.type.value,
                    },
                    {
                        headers: {
                            Authorization: `Bearer ${localStorage.getItem(
            ...
            node.type = this.editGroup.type.value;
