    ...
    <div>
        ...
        <b-row>
            <b-col md="12" lg="12" sm="12">
                <BCard>
                    <h4 class="mb-2">اطلاعات کاربر</h4>
                    <div class="row">
                        ...
                        >
                            <b-input-group class="input-group-merge">
                                <b-form-input autocomplete="off"
                                    ...
                                    class="form-control-merge"
                                    placeholder="کد اپراتور خود ار وارد نمایید"
                                />
                            </b-input-group>
                        </b-form-group>
...
export default {
    ...
    methods: {
        ...
        userUpdateHandler() {
            ...
            const params = {
                ...
                tags: _.map(this.selected_tags, "id"),
                roles: [
                    _.map(this.rolls, (item) => {
                        return item.name;
                    }),
                ],
                        ...
                        .then(() => {
                            this.$toast({
                                ...
                                props: {
                                    ...
                                    icon: "CoffeeIcon",
                                    variant: "success",
                                    text: "اطلاعات شخصی شما بروزرسانی شد.",
                                },
                            });
                        });
                })
    ...
    created() {
        ...
        const id = JSON.parse(localStorage.getItem("userData")).id;
        axios
            .get(`${process.env.VUE_APP_URL}/users/${id}/show`, {
                headers: {
                    Authorization: `Bearer ${localStorage.getItem(
                        "accessToken"
                    )}`,
            ...
            .then(({ data }) => {
                ...
                this.education = _.find(this.education_options, (item) => {
                    return item.text === data.data.profile.education_degree;
                });
                ...
                this.national_code = data.data.profile.nic;
                this.userForm.birth_date = data.data.profile.birth_date;
                this.birth_date = data.data.profile.birth_date;
                this.userForm.anniversary = data.data.profile.anniversary_date;
                this.anniversary = data.data.profile.anniversary_date;
                this.userForm.marital_status = _.find(
                    this.marital_statuses,
                    (item) => {
                        return item.value == data.data.profile.marital_status;
                    }
                );
                ...
                this.education_degree = data.data.profile.education_degree;
        ...
        axios
            .get(`${process.env.VUE_APP_URL}/groups/all/flatten`, {
                headers: {
                    Authorization: `Bearer ${localStorage.getItem(
                        "accessToken"
                    )}`,
        ...
        axios
            .get(`${process.env.VUE_APP_URL}/tags/all`, {
                headers: {
                    Authorization: `Bearer ${localStorage.getItem(
                        "accessToken"
                    )}`,
            ...
            .then(({ data }) => {
                this.tags = _.map(data, (item) => {
                    return _.omit({ ...item, id: item.tag_id }, "tag_id");
                });
            })
            .catch((error) => {});
        //get rolls
        axios
            ...
            .then((response) => {
                // this.rollOptions = _.map(response.data.data, item =>{
                //     return item.display_name
                // })
                this.rollOptions = response.data.data;
            })
            .catch((error) => {});
    },
};
