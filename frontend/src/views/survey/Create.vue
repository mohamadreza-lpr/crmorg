<template>
    <section>
        <form-wizard
            ...
            :subtitle="null"
            shape="square"
            finish-button-text="ایجاد نهایی"
        ...
        >
            ...
            >
                <b-row>
                    <b-col cols="12" class="mb-2">
                        <h5 class="mb-0">ایجاد نظرسنجی</h5>
            ...
            >
                <b-row>
                    <b-col cols="12" class="mb-2">
                        ...
                        >
                            <span>
                                <h5 class="mb-0">ایجاد پرسش ها</h5>
                                <small class="text-muted">
            ...
            <tab-content title="ایجاد پاسخ ها">
                <b-row>
                    <b-col cols="12" class="mb-2">
                        <div
                            class="d-flex flex-row justify-content-between align-items-end"
                        >
                            <span>
                                <h5 class="mb-0">ایجاد پاسخ ها</h5>
                                <small class="text-muted">
...
export default {
    ...
    methods: {
        ...
        async surveyNextHandler() {
            ...
            return await axios
                .post(`${process.env.VUE_APP_URL}/surveys/store`, params, {
                    headers: {
        ...
        addQuestionToSurvey(questionId) {
            ...
            axios
                ...
                .then((response) => {
                    ...
                    this.formAlertVariant = "success";
                    this.formAlertMessages = ["پاسخ مورد نظر باموفقیت ثبت شد"];
                    this.formAlertVisibility = true;
                })
                .catch((error) => {
                    this.formAlertVariant = "danger";
        ...
        choiceStoreHandler() {
            ...
            axios
                ...
                .then(({ data }) => {
                    ...
                    let page = _.round(this.choiceRows / this.choicePerPage);
                    ...
                    this.formAlertVariant = "success";
                    this.formAlertMessages = ["پاسخ جدید با موفقیت ثبت شد"];
                    this.formAlertVisibility = true;
                })
                .catch((error) => {
                    this.modalAlertVariant = "danger";
