        ...
        <b-col md="12" lg="12" sm="12">
            ...
            <BCard>
                ...
                <div class="text-right">
                    <b-button variant="primary" @click="sendProduct">
...
export default {
    ...
    data() {
        return {
            snowOption: {
                placeholder: "توضیحات خود را در این کادر وارد نمایید...",
            },
            code: "",
            description: "",
            groups: "",
    ...
    methods: {
        ...
        currencySeparator(value) {
            this.price = this.removeCurrencySeparator(this.price);
            this.price = this.addCurrencySeparator(this.price);
        },
        getGroups() {
            axios
        ...
        sendProduct() {
            ...
            axios
                .post(`${process.env.VUE_APP_URL}/products/store`, params, {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem(
                            "accessToken"
                        )}`,
