<template>
    <div>
        ...
        <b-alert variant="primary" show>
            <div class="alert-body">
                <h3 class="text-primary">خرید</h3>
                <span>
                    مشتریان به ازای هر خرید یک <strong>امتیاز</strong> معین
                    دریافت می کنند و همچنین به ازای یک میزان حجم خرید معین شده
                    در هر فاکتور <strong>امتیاز</strong> دریافت می کنند.
                </span>
            </div>
        </b-alert>
        <b-card>
            <b-form @submit.prevent="updatePlanHandler">
                <b-row>
                    ...
                    <b-col class="form-group" md="8" offset-md="4">
                        <hr />
                        <div>
                            <b-button
