<template>
    <div>
        ...
        <b-alert variant="primary" show>
            <div class="alert-body">
                <h3 class="text-primary">معرفی به دوستان</h3>
                <span>
                    مشتریان با معرفی دوستان خود، علاوه بر دریافت
                    <strong>امتیاز</strong> به ازای هر خرید مشتری معرفی شده، تا
                    هر تعداد سطح تعیین شده، یک میزان
                    <strong>اعتبار</strong> دریافت خواهند کرد.
                </span>
            </div>
        </b-alert>
        <b-card>
